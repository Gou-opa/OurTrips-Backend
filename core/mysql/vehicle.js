...
module.exports.store = function (vehicle, onSuccessCallback, onFailureCallback) {
    ...
    pool.query("INSERT INTO " + config.vehicle_table + " (brand, name, type, engine_cap, color, gross_ton, total_weight, n_passengers, approval_status, driver_id) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?)", [brand, name, type, engine_cap, color, gross_ton, total_weight, n_passengers, 'WAITING' , driver_id], function (err, result) {
